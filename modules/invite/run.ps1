...
$COLLECTION = Join-Path $MODULE_ROOT "collection\invite.postman_collection.json"
...
Write-Host "Running INVITE API tests..."
Invoke-Newman "Invite Member" (Join-Path $DATA_DIR "invite-member.data.json") "01-invite-member"

Write-Host ""
Write-Host "INVITE complete. HTML -> $REPORT_DIR | JSON -> $JSON_DIR"
