...
$REPORT_DIR = "reportsJson/projects"
...
newman run $COLLECTION -e $ENV `
 ...
 -r json `
 --reporter-json-export "$REPORT_DIR/01-create-project.json"
...
newman run $COLLECTION -e $ENV `
 ...
 -r json `
 --reporter-json-export "$REPORT_DIR/02-get-all-projects.json"
...
newman run $COLLECTION -e $ENV `
 ...
 -r json `
 --reporter-json-export "$REPORT_DIR/03-update-project.json"
...
newman run $COLLECTION -e $ENV `
 ...
 -r json `
 --reporter-json-export "$REPORT_DIR/04-change-project-status.json"
